...
class GameEngine:
    ...
    def __initialize_display_and_music(self):
        ...
        pygame.display.set_caption("Treasure Crush")
        # music
        music.load()
    ...
    def menuStart(self):
        ...
        while running:
            ...
            #         pass
                curGameView = GameView("Regular", config.GAME_MODE, pygame.display.get_surface())
                curGameView.runGame()
            ...
            menu = pygame_menu.Menu('Treasure Crush', self.resolution[0], self.resolution[1],
                                    theme=my_theme)

            menu.add.button('Start', start_the_game)

            menu.add.selector('Level Selection :', [('Level 1', 1), ('Level 2', 2)], onchange=select_mode)
